...
class AudioController:
    ...
    def save_user_audio_recording(self, user_id: UUID, video_id: str) -> None:
        ...
        try:
            ...
            self._audio_service.save_user_audio_recording(user_id, video_id, get_json_content())
    ...
    def get_all_user_audio_recordings(self, user_id: UUID) -> list[OutputAudioRecording]:
        ...
        try:
            ...
            result = self._audio_service.get_all_user_audio_recordings(user_id)
    ...
    def delete_user_audio_recording(self, user_id: UUID, video_id: str) -> None:
        ...
        try:
            ...
            self._audio_service.delete_user_audio_recording(user_id, video_id)
            self._log.info(f'End [funcName](user_id=\'{user_id}\', video_id=\'{video_id}\')')
